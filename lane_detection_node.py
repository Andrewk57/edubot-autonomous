...
class LaneDetectionNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('target_yellow_x_ratio', 0.38)  # offset right of yellow to stay between lines
        self.declare_parameter('white_x_min_ratio', 0.45)
        self.declare_parameter('yellow_weight', 0.70)  # yellow is now the primary reference
